...
Item {
    ...
    Kirigami.Theme.positiveTextColor: "#a89984"
    Kirigami.Theme.neutralTextColor: "#fabd2f"
    ...
    MouseArea {
        ...
        // SDDM creates one greeter view per monitor. Keep the background on all
        // monitors, but show/login-focus the actual UI only on the XRandR
        // primary monitor. The primary monitor is selected by
        // /usr/local/bin/sddm-gruvbox-xsetup.
        ...
        QQC2.StackView {
            ...
            focus: primaryScreen //StackView is an implicit focus scope, so we need to give this focus so the item inside will have it
            ...
            Timer {
                ...
                onTriggered: {
                    if (primaryScreen) {
                        ...
                        Qt.callLater(userListComponent.focusFirstVisibleFormControl);
                    }
                }
            }
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ...
                    GruvboxActionButton {
                        ...
                        onActivated: mainStack.push(userPromptComponent)
